...
filename="PICAR_count_mix_run.RData"
CVfilename="CV_PICAR_count_mix_run.RData"
...
data     <- list(Z=Z , MQM_O = MQM_O , MQM_P = MQM_P , mn=rep(0,n) )
...
# [,1]      [,2]
# [1,] 0.463543 0.6120646
# > cvMSPE_ZIP[[3]] #Recall
# [,1]      [,2]
# [1,] 0.4880701 0.5796417
# > cvMSPE_ZIP[[4]] #F1
# [,1]      [,2]
# [1,] 0.4754905 0.5954121
# 
# 
# install.packages("LaplacesDemon")
# library(LaplacesDemon)
# burnin<-nrow(samples_extended)*0.7
# # burnin=2
# round(pnorm(Geweke.Diagnostic(samples_extended[-(1:burnin),])),3)
# 
# dim(samples_extended[-(1:burnin),1:2])
# 
# plot.ts(samples_extended[-(1:burnin),"delta_P[11]"])

...
filename="PICAR_count_hurdle_run.RData"
CVfilename="CV_PICAR_count_hurdle_run.RData"
...
Rmodel<-nimbleModel(code=PICAR_count_model_string, data = data,  
...
# plotRF(dat=re,rangeDat=c(ObsDat$gpW.mod,re),label="P-Model",location=ObsDat$grid.location.mod[posInd,],length.out=10)
# plotRF(dat=ObsDat$gpW.mod[posInd],rangeDat=c(ObsDat$gpW.mod,re[posInd]),label="P-Truth",
#        location=ObsDat$grid.location.mod[posInd,],length.out=10)

# > cvMSPE[[1]] #RMSPE
# [1] 2.308060 2.228965
# > cvMSPE[[2]] #Precision
# [,1]      [,2]
# [1,] 0.4472243 0.5170608
# > cvMSPE[[3]] #Recall
# [,1]      [,2]
# [1,] 0.449673 0.5908399
# > cvMSPE[[4]] #F1
# [,1]      [,2]
# [1,] 0.4484453 0.5514938